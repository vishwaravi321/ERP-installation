...
script(){
    ...
    sudo apt install -y curl nginx python3-dev python3-setuptools python3-pip virtualenv fail2ban libmysqlclient-dev redis-server xvfb libfontconfig wkhtmltopdf python3-pip software-properties-common lolcat python3-venv mariadb-server supervisor
